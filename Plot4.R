...
plot(sub$timestamp, sub$Global_active_power, ylab="Global Active Power", type="l", xlab="")

plot(sub$timestamp, sub$Voltage, ylab="Voltage", type="l", xlab="datetime")
...
plot(sub$timestamp, sub$Global_reactive_power, ylab="Global_reactive_power", type="l", xlab="datetime")
